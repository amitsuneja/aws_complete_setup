...
resource "aws_route53_record" "DomainController1" {
        ...
        name                = join(".", [var.DNSNAME,var.DOMAINNAME])
        type                = "A"
        ttl                 = "300"
...
locals {
  ...
  dns_name_local_var = [join(".", [var.DNSNAME,var.DOMAINNAME])]
}
...
resource "aws_route53_record" "ldap0001" {
        ...
        type                = "SRV"
        ttl                 = "300"
        records             = toset([join(" ", ["1 50 389"], local.dns_name_local_var)])
#        records             = ["1 50 389 join('.', [ var.DNSNAME, var.DOMAINNAME])"]
#        records             = ["1 50 389 var.DNS1NAME.var.DOMAINNAME","1 50 389 ${var.DNS2NAME}.${var.DOMAINNAME}"]
}
#
...
#        zone_id             = "${aws_route53_zone.selected.zone_id}"
#        name                = "_ldap._tcp.pdc._msdcs.${var.DOMAINNAME}"
#        type                = "SRV"
#        ttl                 = "300"
#        records             = ["1 50 389 ${var.DNS1NAME}.${var.DOMAINNAME}","1 50 389 ${var.DNS2NAME}.${var.DOMAINNAME}"]
#}
...
#        zone_id             = "${aws_route53_zone.selected.zone_id}"
#        name                = "_ldap._tcp.gc._msdcs.${var.DOMAINNAME}"
#        type                = "SRV"
#        ttl                 = "300"
#        records             = ["1 50 3268 ${var.DNS1NAME}.${var.DOMAINNAME}","1 50 3268 ${var.DNS2NAME}.${var.DOMAINNAME}"]
#}
#
#resource "aws_route53_record" "ldap0005" {
#        zone_id             = "${aws_route53_zone.selected.zone_id}"
#        name                = "_gc._tcp.${var.DOMAINNAME}"
#        type                = "SRV"
#        ttl                 = "300"
#        records             = ["1 50 3268 ${var.DNS1NAME}.${var.DOMAINNAME}","1 50 3268 ${var.DNS2NAME}.${var.DOMAINNAME}"]
#}
...
#        zone_id             = "${aws_route53_zone.selected.zone_id}"
#        name                = "_kerberos._tcp.${var.DOMAINNAME}"
#        type                = "SRV"
#        ttl                 = "300"
#        records             = ["1 50 88 ${var.DNS1NAME}.${var.DOMAINNAME}","1 50 88 ${var.DNS2NAME}.${var.DOMAINNAME}"]
#}
#
#resource "aws_route53_record" "ldap0007" {
#        zone_id             = "${aws_route53_zone.selected.zone_id}"
#        name                = "_kerberos._udp.${var.DOMAINNAME}"
#        type                = "SRV"
#        ttl                 = "300"
#        records             = ["1 50 88 ${var.DNS1NAME}.${var.DOMAINNAME}","1 50 88 ${var.DNS2NAME}.${var.DOMAINNAME}"]
#}
...
#        zone_id             = "${aws_route53_zone.selected.zone_id}"
#        name                = "_kpasswd._tcp.${var.DOMAINNAME}"
#        type                = "SRV"
#        ttl                 = "300"
#        records             = ["1 50 464 ${var.DNS1NAME}.${var.DOMAINNAME}","1 50 464 ${var.DNS2NAME}.${var.DOMAINNAME}"]
#}
#
#resource "aws_route53_record" "ldap0009" {
#        zone_id             = "${aws_route53_zone.selected.zone_id}"
#        name                = "_kpasswd._udp.${var.DOMAINNAME}"
#        type                = "SRV"
#        ttl                 = "300"
#        records             = ["1 50 464 ${var.DNS1NAME}.${var.DOMAINNAME}","1 50 464 ${var.DNS2NAME}.${var.DOMAINNAME}"]
#}
...
#      element( split(".", aws_vpc.MyVpc.cidr_block) ,1),
